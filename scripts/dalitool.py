...
def main():
    parser = argparse.ArgumentParser(description="Post-process DALI output file (raw DALI .txt file or parsed .tsv)")
    parser.add_argument('--in', dest='infile', default=None,
                        help="Input file (default: stdin)")
    parser.add_argument('--out', dest='outfile', default=None,
                        help="Output file (default: stdout)")
    parser.add_argument('--parse', action='store_true',
                        help="Parse DALI .txt file into TSV format")
    parser.add_argument('--annotate', action='store_true', help="Add Pfam annotations of aligned fragments")
    ...
    parser.add_argument('--target', dest='target', default="USER",help="Name of target database (optional with --parse)")
    parser.add_argument('--treeorder', action='store_true', help=argparse.SUPPRESS)
    parser.add_argument('--pfamdir', help="Path to HMM profile library (required with --annotate)")
