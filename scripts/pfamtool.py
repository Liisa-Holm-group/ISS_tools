...
"""
    ...
    parser.add_argument(
        "--download",
        action="store_true",
        help="Download Pfam-A.hmm and Pfam-A.hmm.dat. Index and parse to TSV.",
    )
    parser.add_argument(
        "--update",
        action="store_true",
        help="Scan DALI .dat files and run hmmsearch on the sequences.",
    )
    parser.add_argument(
        "--pfamdir",
        type=str,
        default="../pfamdata/",
        help="Directory for Pfam data. Required with --download, --update, --search.",
    )
    parser.add_argument(
        "--dat",
        type=str,
        default="./DAT/",
        help="Directory containing DALI .dat files. Required with --update.",
    )
    parser.add_argument(
        "--out",
        type=str,
    ...
    parser.add_argument(
        "--search",
        type=str,
        help="Input FASTA file for hmmsearch. Parse results to TSV",
    )
    parser.add_argument(
        "--parse", type=str, help="Parse hmmsearch output file (txt) into TSV."
    )
